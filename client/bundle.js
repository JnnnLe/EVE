...
/***/ function(module, exports, __webpack_require__) {
	...
	//only done once, to render the APP into index.html
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timeAndGreeting = __webpack_require__(161);

	var _timeAndGreeting2 = _interopRequireDefault(_timeAndGreeting);

	var _weather = __webpack_require__(162);
	...
	var _quote = __webpack_require__(189);

	var _quote2 = _interopRequireDefault(_quote);

	var _ImgLink = __webpack_require__(190);

	var _ImgLink2 = _interopRequireDefault(_ImgLink);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_timeAndGreeting2.default, null),
					_react2.default.createElement(_links2.default, null),
					_react2.default.createElement(_quote2.default, null),
					_react2.default.createElement('imgLink', null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeAndGreeting = function (_Component) {
		_inherits(TimeAndGreeting, _Component);

		function TimeAndGreeting() {
			_classCallCheck(this, TimeAndGreeting);

			return _possibleConstructorReturn(this, (TimeAndGreeting.__proto__ || Object.getPrototypeOf(TimeAndGreeting)).apply(this, arguments));
		}

		_createClass(TimeAndGreeting, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
		...
		return TimeAndGreeting;
	}(_react.Component);

	;

	exports.default = TimeAndGreeting;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API = '6b2efa163b9b7e6a108704a52f170828';
	var ROOT_URL = 'http://api.openweathermap.org/data/2.5/weather?APPID=' + API;
		...
		_createClass(Weather, [{
			...
			value: function componentWillMount() {
				navigator.geolocation.getCurrentPosition(function (position) {
					console.log('this is the position coordinates, ', position.coords);
				});
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'gMail' },
						'Google Mail Signin and ACcount'
					),
					';',
					_react2.default.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImgLink = function (_Component) {
		_inherits(ImgLink, _Component);

		function ImgLink() {
			_classCallCheck(this, ImgLink);

			return _possibleConstructorReturn(this, (ImgLink.__proto__ || Object.getPrototypeOf(ImgLink)).apply(this, arguments));
		}
